...
re.on_frame(function()
    ...
    if is_game_active and d2d_cfg.hud_show then
        ...
        elseif trial_state.is_playing and ((trial_state.fail_timer and trial_state.fail_timer > 0) or trial_state.manual_reset_pending) then
            ...
            show_our_hud = true
        elseif trial_state.is_recording then
            line1 = "[ 正在录制 P" .. tostring(trial_state.recording_player + 1) .. " ]"; col1 = 0xFF5555FF
            show_our_hud = true
        elseif trial_state.is_playing then
            local is_demo_active = (ctx.demo_state and ctx.demo_state.is_playing)
            ...
            if demo_countdown > 0 then
                ...
                if trial_state.floating_info then
                    line1 = line1 .. "  |  " .. zh_status_text(trial_state.floating_info)
        ...
        elseif trial_state.is_playing and #trial_state.sequence > 0 and trial_state.sequence[1] then
            ...
            if cs then
                line2 = cs.damage and cs.damage > 0 and string.format("伤害: %d", cs.damage) or "伤害: ---"
...
_G.FloatingScriptUI.register("连段训练设置v0.8e", draw_combo_trials_menu_ui)
end
